...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        elif exec_type == "tree_decoding_torch":
            y = self.tree_decoding_torch(hidden_states, position_embeddings, cache_lens, tree_mask)
    ...
    def prefill_torch(
        ...
        self.K_Cache = query_states.new_zeros((bsz, self.num_key_value_heads, q_len + self.max_len + 256, self.head_dim))
        self.V_Cache = query_states.new_zeros((bsz, self.num_key_value_heads, q_len + self.max_len + 256, self.head_dim))
    ...
    def tree_decoding_torch(
        ...
        if tree_mask is None:
            ...
            # print(key_states.shape, self.K_Cache.shape)
            # print(bsz_indices, range_indices)
        ...
        # torch.cuda.synchronize()
        # print("ori attention time", time.time() - record_time)
