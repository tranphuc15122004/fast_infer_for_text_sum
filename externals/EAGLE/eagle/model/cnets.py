...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # Qwen3-4B uses an explicit head_dim (128) even though
        # hidden_size // num_attention_heads is 80.
    ...
    def forward(
        ...
        if self.config.pretraining_tp > 1:
            input_dim = (self.num_heads * self.head_dim) // self.config.pretraining_tp
            attn_output = attn_output.split(input_dim, dim=2)
            o_proj_slices = self.o_proj.weight.split(input_dim, dim=1)
