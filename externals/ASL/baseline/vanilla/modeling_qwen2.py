...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        if past_key_value is not None:
            ...
            if q_len > 1:
                past_key_value.prefilling_score_update(query_states,key_states,value_states,self.layer_idx) #[Adaptive Select Layer] 
...
class Qwen2FlashAttention2(Qwen2Attention):
    ...
    def forward(
        ...
        #split output and o_project by chunk
        # chunk_size = past_key_value.mlp_chunk_size
        # for start_idx in range(0, q_len, chunk_size):
        #     end_idx = min(q_len, start_idx + chunk_size)
        #     attn_output[:, start_idx:end_idx, :] = self.o_proj(
