...
#[asl] Instead of copying and paste llama code here, we directly import its code from current directly
from .modeling_llama_pyramidinfer import LlamaForCausalLM, CausalLMOutputWithPastForPMT,BaseModelOutputWithPastForPMT
...
from .modeling_llama_pyramidinfer import apply_rotary_pos_emb
...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        query_states, key_states = apply_rotary_pos_emb(query_states, key_states, cos, sin, position_ids, selected_position_ids) #pyramidinfer
...
class Qwen2ForCausalLM(Qwen2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        # print(F"{len(outputs.recent_attn_weights)=}")
    ...
    _update_model_kwargs_for_generation = LlamaForCausalLM._update_model_kwargs_for_generation
