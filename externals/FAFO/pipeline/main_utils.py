...
def parse_args():
    ...
    parser.add_argument('--job_post_via', default='terminal', type=str, help='slurm_sbatch or terminal')
...
def set_logger(output_folder_dir, args): 
    ...
    log_formatter.converter = lambda *args: datetime.datetime.now().astimezone().timetuple()
