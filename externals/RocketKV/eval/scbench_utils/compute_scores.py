...
import evaluate
from eval.scbench_utils.args import parse_args
from eval.scbench_utils.repo_qa_utils import compute_score as compute_repoqa_score
...
if __name__ == "__main__":
    ...
    if args.task == "all":
        ...
        tasks = [args.task]
    for task in tasks:
        preds_path = Path(args.output_dir)
