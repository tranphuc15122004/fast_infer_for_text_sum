...
if [ $method == "baseline" ]; then
  for dataset in scbench_kv scbench_prefix_suffix scbench_vt scbench_repoqa scbench_qa_eng scbench_qa_chn scbench_choice_eng  scbench_many_shot scbench_summary scbench_mf scbench_summary_with_needles scbench_repoqa_and_kv; do
  ...
  python visualization/scbench_results_summary/scbench_tasks_summary.py \
