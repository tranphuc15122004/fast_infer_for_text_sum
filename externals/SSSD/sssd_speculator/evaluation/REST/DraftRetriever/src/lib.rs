...
// 2022 Gal Ben David; 2023 Zhenyu He, Zexuan Zhong, Tianle Cai).
//
// Modification (see THIRD_PARTY_NOTICES.md at the repository root for details):
//   - `Reader::new()` reads a 4-byte flag at the start of the index file to
//     detect whether tokens are encoded as u16 (original upstream format) or
//     u32 (SSSD large-vocabulary format, used when vocab_size > 65535).
//
// All other code, the public Python API, and the `draftretriever` module name
