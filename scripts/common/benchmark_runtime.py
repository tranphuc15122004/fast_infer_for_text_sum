...
def _common_record(
    *,
    ...
    record: dict[str, object] = {
        ...
        "scope": "sample",
        "input_tokens": None,
        "original_input_tokens": config.get("original_input_tokens"),
        "input_truncated": config.get("input_truncated", False),
        "output_tokens": None,
        "speed_output_tokens": config.get("speed_output_tokens"),
