...
def build_specextend_sample_record(
    *,
    ...
    record = {
        ...
        "retained_tokens": stats.get("input_tokens"),
        ...
        "model_load_ms": stats.get("model_load_ms"),
        "returncode": returncode,
        "accept_length_list": stats.get("accept_length_list"),
        "acceptance_lengths": stats.get("accept_length_list"),
        "avg_accept_length": stats.get("avg_accept_length"),
        "acceptance_rate": stats.get("acceptance_rate"),
        "draft_latency_ms": stats.get("draft_latency_ms"),
        "verification_latency_ms": stats.get("verification_latency_ms"),
        "draft_tokens_proposed": stats.get("draft_tokens_proposed"),
        "draft_tokens_accepted": stats.get("draft_tokens_accepted"),
        "rejected_draft_ratio": stats.get("rejected_draft_ratio"),
