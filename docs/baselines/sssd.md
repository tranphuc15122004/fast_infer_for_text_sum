...
- Cần GPU CUDA, fork SGLang tương thích với torch/CUDA/GPU, package native
  `sglang-kernel==0.4.7` (được build cho Torch 2.14 trong runtime này), package
